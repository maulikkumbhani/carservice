            ...
            <?php
             ...
             ?>
              <div class="gallery-item wheel">
                <a href="v_C_M_detail.php?m_code=<?php echo $data['m_code']; ?>" >
                <div class="work-gallery">
                  <div class="gallery-thumb">

                    <img style="height: 200px;" class="img-fullwidth" style="width: 200px; height: 250px;" src="<?php echo $data['c_image1']; ?>" />
