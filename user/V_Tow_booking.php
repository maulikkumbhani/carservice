                  ...
                  <div class="col-sm-6">
                    <div class="form-group mb-30">
                      <label>User Name</label>
                       <input placeholder="Type Your Name Here" type="text" id="car_model" name="name" class="form-control" value="<?php if(isset($_POST['name'])){echo $_POST['name'];}?>" required data-errormessage-value-missing="Please Enter User Name" style="margin-bottom: 70px;">
                      </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="form-group mb-30" >
                      <label>Email</label>
                      <input placeholder="Type Email Here" type="Email" id="car_model" name="email" class="form-control" value="<?php if(isset($_POST['email'])){echo $_POST['email'];}?>" required data-errormessage-value-missing="Please Enter  Email " style="margin-bottom: 70px;">
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group mb-30">
                   ...
                   <input placeholder="Type Car Number Here" type="text" id="car_model" name="contact" class="form-control" pattern="[6789][0-9]{9}" value="<?php if(isset($_POST['contact'])){echo $_POST['contact'];}?>"  required data-errormessage-pattern-mismatch="Please Enter Valid Contact Number"  data-errormessage-value-missing="Please Enter Contact Number"  style="margin-bottom: 70px;">
...
if($sqlins1 && $sql2)
  {
                             ...
                             $link="http://localhost/carservice/user/V_Tow_A_detail.php?t_a_code=$t_a_code";
...
echo "<script> location.href='V_Tow_vendor_mail.php?t_code=$t_code&w=$t_a_code'; </script>"; 
