                              ...
                              <div style="width: 100%; margin-bottom: 50px;" class="col-md-6">
                                ...
                                <ul>
                                 ...
                                 <td  >
                                    ...
                                    <div  class="col-md-4" >
                                          <img src="<?php if($data['t_profile']==NULL){echo "../uploads/v_t_profile/default.jpg";}else{ echo $data['t_profile']; }?>" style="width:200px;height: 200px;">
                                  ...
                                  <li>
                                    ...
                                    <a href="Tow_booking.php?t_code=<?php echo $data['t_code'];?>" class="btn btn-dark btn-xl">Book Appointment</a></br>
                                     </li>  </td>
                                  </li>
                                  </tr>
