         ...
         if (!empty($_POST["re_password"])) 
         {
           ...
           if ($_POST["re_password"] == $_POST["password"]  ) 
           {
             ...
             {	
              ...
              $password = "";
              $user_code = createRandomPassword();

              $check = mysql_query("SELECT user_code FROM user_info WHERE user_code = '$user_code'");
              ...
              {   
               ...
               {
                 $email = "";
                 $sql = "INSERT INTO user_info(username,email,user_code,password,status) VALUES('$username_get','$email_get','$user_code','$password_get','$status')";
    ...
    <section class="signup">
      <div class="container">
        <div class="signup-content">
          ...
          <div class="signup-form">
            ...
            <div class="form-group">
              ...
              <input type="text" name="email" value="<?php if(isset($_POST['email'])){ echo $_POST['email'];} ?>" id="email" placeholder="Your Email" />
            </div>
        ...
        <div class="signup-image">
          ...
          <a href="U_login.php" class="signup-image-link">I have already account</a>
        </div>
      </div>
    </div>
  </section>
