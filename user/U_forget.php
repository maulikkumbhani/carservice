             ...
             if(!filter_var($_POST['email'],FILTER_VALIDATE_EMAIL))
               {
            ...
            else
                  {
                        ...
                        $sql=mysql_query("SELECT * FROM user_info WHERE email='$check_email'");
          ...
          else
          {
            $upassword = $_POST['password'];
             if(empty($_POST['re_password']))
              ...
              {
                  $ure_password = $_POST['re_password'];
                  ...
                  {
                    $usql=mysql_query("UPDATE `user_info` SET `password`='$upassword' WHERE email='$uemail'");
                    if($usql)
                    {
                      echo "<script>alert('Password updated successfully.'); location.href='u_login.php';</script>";
                    }
                    else
                    {
