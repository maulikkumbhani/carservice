    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="images/bg/bg6.jpg">
      <div class="container pt-90 pb-50">
        ...
        <div class="section-content pt-100">
          <div class="row"> 
            <div class="col-md-12">
              <h3 class="title text-white">Car Brand</h3>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
           ...
           <div id="grid" class="gallery-isotope grid-4 gutter clearfix">
            <?php
               ...
               $car_brand = mysql_query("SELECT * FROM c_brandname;");
             ...
             ?>
              ...
              <div class="gallery-item wheel">
                <a href="V_C_M_list.php?b_code=<?php echo $data['b_code']; ?>" ><i class="fa fa-link"></i>
                <div class="work-gallery">
                  <div class="gallery-thumb">
                    <img style="height: 200px;" class="img-fullwidth" alt="<?php echo $data['b_name']; ?>" src="<?php echo $data['image_url']; ?>?">
                  ...
                  <div class="gallery-bottom-part text-center">
                    <h4 class="title text-uppercase font-raleway font-weight-500 m-0"><?php echo $data['b_name']; ?></h4>
