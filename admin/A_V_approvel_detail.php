        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce" style="padding: 20px;">
                <ol class="breadcrumb bc-3">
                    ...
                    <li>
                        <a href="A_approval.php">Approval List</a>
                    </li>
                    <li>
                        <a href="A_V_approval_detail.php">Approval Detail</a>
                    </li>
                </ol><br />
                <div>
...
?>
                    ...
                    <div style="margin-left:7%;margin-right:7%;margin-top: 30px;margin-bottom: 10px;">
                        ...
                        <div class="col-xs-5" style="float: right;   ">
                            <a href="#">
                                <img src="<?php  if($data1['v_image'] == NULL) { echo "../uploads/v_profile/user.png"; }else{ echo $data1['v_image'];} ?>"
                                    style='height:150px; border-radius: 5px 5px 5px 5px;  width:150px; class='
                                    img-responsive img-rounded full-width />
                            </a>
                        </div>
                        ...
                        <form method="POST">
                            <table>
                                <tr>
                                    <td style="padding-right: 20px;">
                                        <h4><b>Garage Name</b></h4>
                                    <td>
                                        <h4 style="padding-right: 5px;">:</h4>
                                    </td>
                                    </td>
                                    <td>
                                        <h4><?php echo $data['g_name']; ?></h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-right: 20px;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4><?php echo $data['contact_no']; ?></h4>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4><?php echo $data['g_opentime']; ?></h4>
                                    </td>

                                </tr>
                                <tr>
                                    <td style="padding-right: 20px;">
                                        <h4><b>close time</b></h4>
                                    <td>
                                        <h4 style="padding-right: 5px;">:</h4>
                                    </td>
                                    </td>
                                    <td>
                                        <h4><?php echo $data['g_closetime']; ?></h4>
                                    </td>
                            ...
                            <div class="row" style="margin-top: 20px;">
                                ...
                                <div>
                                    ...
                                    function initMap() {
                                        var uluru = {
                                            lat: < ? php echo $data['location_lat']; ? > ,
                                            lng : < ? php echo $data['location_lng']; ? >
                                        };
                            ...
                            <div class="row" style="margin-top: 20px;">
                                ...
                                <div class="col-xs-3">
                                    <a href="#">
                                        <img src="<?php  if($data['g_imageurl1'] == NULL) { echo "../uploads/v_garage/no-image.png"; }else{ echo $data['g_imageurl1'];} ?>"
                                            style='height:150px; border: 1px solid #BFBFC0; border-radius: 5px 5px 5px 5px;  width:150px; class='
                                            img-responsive img-rounded full-width />
                                    </a>
                                </div>
                                <div class="col-xs-3">
                                    <a href="#">
                                        <img src="<?php  if($data['g_imageurl2'] == NULL) { echo "../uploads/v_garage/no-image.png"; }else{ echo $data['g_imageurl2'];} ?>"
                                            style='height:150px; border: 1px solid #BFBFC0; border-radius: 5px 5px 5px 5px;  width:150px; class='
                                            img-responsive img-rounded full-width />
                                    </a>
                                </div>
                                <div class="col-xs-3">
                                    <a data-rel="prettyPhoto" href="<?php echo $data['g_imageurl3']; ?>">
                                        <img src="<?php  if($data['g_imageurl3'] == NULL) { echo "../uploads/v_gargae/no-image.png"; }else{ echo $data['g_imageurl3'];} ?>"
                                            style='height:150px; border: 1px solid #BFBFC0; border-radius: 5px 5px 5px 5px;  width:150px; class='
                                            img-responsive img-rounded full-width />
                                    </a>
                                </div>
                            ...
                            <div style="margin-top:20px;">
                                <p class="bs-example bs-baseline-top">
                                    <a href="A_V_approvel_detail.php?g_code=<?php echo $data['g_code'];?>">
                                        <button style="width: 150px;" name="Reject" type="submit"
                            ...
                            <form method="POST">
                                ...
                                <table>
                                    <tr>
                                        <td>
                                            <p class="bs-example bs-baseline-top">
                                                <button style="width: 150px;" name="ok" type="submit"
                                                    class="btn btn-default btn-lg">Ok</button>
                                            </p>
                                        </td>
                                        <td>
                                            <p class="bs-example bs-baseline-top">
                                                <button style="width: 150px;" name="cancel" type="submit"
...
if (isset($_POST['ok'])) 
{
 $description = $_POST['description'];
  ...
  $mail ->SetFrom("carcareservice16122@gmail.com");
   ...
   $mail ->Body = "changepassword.php?email=$email";
   ...
   else
   {
      ...
      echo "<script> location.href='A_approved.php'; </script>";
    ob_end_flush();
...
?>
    ...
    <div id="chat" class="fixed" data-current-user="Art Ramadani" data-order-by-status="1" data-max-chat-history="25">
        <div class="chat-inner">
            <h2 class="chat-header"> <a href="#" class="chat-close"><i class="entypo-cancel"></i></a>
