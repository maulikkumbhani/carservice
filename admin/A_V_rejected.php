 ...
 <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="description" content="Neon Admin Panel" />
   <meta name="author" content="Laborator.co" /> 
     ...
     <title>Garage | Rejected</title> <link rel="stylesheet" href="assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css" id="style-resource-1">
...
<div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;">
 ...
 <div class="dashboard-wrapper">
        ...
        <li>
          <a href="A_V_rejected.php">Rejected Detail</a> 
        </li>
        </ol><br />
            	<div>
...
if (isset($_POST['ok'])) 
{
 $description = $_POST['description'];
   ...
   else
   {
	  ...
	  echo "<script> location.href='A_rejected.php'; </script>";
	ob_end_flush();
