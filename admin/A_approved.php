 ...
 <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="description" content="Neon Admin Panel" />
   <meta name="author" content="Laborator.co" /> 
     ...
     <title>Garage | Approved</title> <link rel="stylesheet" href="assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css" id="style-resource-1">
...
<div class="main-content"> 
	<div class="row"> 
           <div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;">
           	<h2>Garage Approval List</h2></div>
        ...
        <ol class="breadcrumb bc-3" > 	
   			...
   			<li>
                ...
                <div>
                    ...
                    <?php
                        $sql = mysql_query("SELECT * from v_garage WHERE approval='granted'");
                           if (mysql_num_rows($sql) == 0) {
                        	echo "No Approved Garages Available";
                        }
                        else
                        {
