 ...
 <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="description" content="Neon Admin Panel" />
   <meta name="author" content="Laborator.co" /> 
     ...
     <title>Tow | Detail</title> <link rel="stylesheet" href="assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css" id="style-resource-1">
...
<div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;">
			<h2>Towing Approval Data</h2></div>
 ...
 <div class="dashboard-wrapper">
        ...
        <li>
          <a href="A_home.php">Towing Detail</a> 
        </li> 
        <li>
          <a href="T_pending.php">Towing List</a> 
        </li>
        <li>
          <a href="T_V_approval_detail.php">Approved towing vendor</a> 
        </li>
        </ol><br />
            	<div>
...
<div style="margin-left:7%;margin-right:7%;margin-top: 30px;margin-bottom: 10px;">
	...
	<div class="col-xs-5" style="float: right;   "> 
		                <a href="#"> 
		              <img src="<?php  if($data['t_profile'] == NULL) { echo "../uploads/v_profile/user.png"; }else{ echo $data['t_profile'];} ?>" style='height:150px; border-radius: 5px 5px 5px 5px;  width:150px; class='img-responsive img-rounded full-width /> 
			         </div>
	...
	<form method="POST"> 
		<table style="margin-left: 50px;">
		 <tr>
	                           <td style="padding-right: 20px;"><h4 ><b>Company Name</b></h4><td><h4 style="padding-right: 5px;">:</h4></td></td> <td><h4><?php echo $data['t_name']; ?></h4></td>
                            </tr>
                            <tr>
                            	<td style="padding-right: 20px;"><h4 ><b>Email</b></h4><td><h4 style="padding-right: 5px;">:</h4></td></td> <td><h4><?php echo $data['t_email']; ?></h4></td>
	                           
                            </tr>
                            <tr>
                            	<td style="padding-right: 20px;"><h4 ><b>Contact No</b></h4><td><h4 style="padding-right: 5px;">:</h4></td></td> <td><h4><?php echo $data['t_contact']; ?></h4></td>

                            </tr>
                            <tr>
                            	<td style="padding-right: 20px;"><h4 ><b>Address</b></h4><td><h4 style="padding-right: 5px;">:</h4></td></td> <td><h4><?php echo $data['t_address']; ?></h4></td>

                            </tr>
                            <tr>
                            	<td style="padding-right: 20px;"><h4 ><b>Driving Linces NUmber</b></h4><td><h4 style="padding-right: 5px;">:</h4></td></td> <td><h4><?php echo $data['dl_number']; ?></h4></td>
...
if (isset($_POST['ok'])) 
{
    ...
    $q1= mysql_query ("UPDATE `t_vender` SET  description ='$description',approval='rejected' WHERE t_code = '$t_code'") or die(mysql_error());
 	
	
     if($q1)
      {
      	ob_start();
           $vender_email = $data['t_email'];
   ...
   else
   {
	  ...
	  echo "<script> location.href='T_pending.php'; </script>";
	ob_end_flush();
...
?>
 ...
 if (isset($_POST['Accept']))
  { 
       $q2 = mysql_query ("UPDATE `t_vender` SET  approval ='$granted' WHERE t_code = '$t_code'");
     if($q2)
      {
        $vender = $data['t_email'];
         require 'PHPMailer-master/PHPMailerAutoload.php';
