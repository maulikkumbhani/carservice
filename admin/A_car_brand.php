...
<div class="main-content"> 
	<div class="row"> 
           <div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;"><h2>Car Brand</h2></div>
 ...
 <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce" style="padding: 20px;">
   			...
   			<li>
            	...
            	<div>
                <H3 style="text-align: center;">Car Show</H3>
<?php

     $sql = mysql_query("SELECT * from c_brandname;");
         while ($data = mysql_fetch_assoc($sql))
         {
        
?>
<a href="A_car_model.php?b_code=<?php echo $data['b_code'];?>">
<div style="height:200px;display: inline-block;margin: 10px;" >


  
               
        <img src="<?php echo $data['image_url']; ?>" style="width:200px;height:170px;" >
        <h3><center><?php echo $data['b_name']; ?></center> </h3>
