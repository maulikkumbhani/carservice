 ...
 <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="description" content="Neon Admin Panel" />
   <meta name="author" content="Laborator.co" /> 
     ...
     <title>Tow | Approved</title> <link rel="stylesheet" href="assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css" id="style-resource-1">
...
<div class="main-content"> 
	<div class="row"> 
           <div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;"><h2>Towing Request For Approval</h2></div>
...
<div class="dashboard-wrapper">
 ...
 <ol class="breadcrumb bc-3" >   
        ...
        <li>
          <a href="T_approval.php">Towing List</a> 
        </li>
        </ol><br />
                <div>
            	
                    <?php
                        $sql = mysql_query("SELECT * from t_vender WHERE approval='granted'");
                         if (mysql_num_rows($sql) == 0) {
                        	echo "No Granted  Towing vendor Available";
                        }
                        else
                        {
                    ...
                    ?>
                    <div style="margin-left:10%;margin-right:10%;margin-top:30px;margin-bottom: 20px;   " >
                ...
                <div style="margin-top: 20px;">
                	<p class="bs-example bs-baseline-top"> 
                            			<a href="T_V_approvel_detail.php?t_code=<?php echo $data['t_code'];?>"> 
                ...
                <div style="border: 0.5px solid #706D6D; margin-left: 7%;margin-right: 7s%;"></div>
                <?php 
                    } 
                }
                ?>
