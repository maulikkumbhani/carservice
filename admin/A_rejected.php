...
<div class="main-content"> 
	<div class="row">
           <div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;"><h2>Garage Rejected List</h2></div>
...
<div class="dashboard-wrapper">
            <div class="dashboard-ecommerce" style="padding: 20px;">
   			...
   			<li>
   				<a href="A_rejected.php">Rejected List</a> 
   			</li>
   			</ol><br />
                ...
                <div>
                    ...
                    <?php
                        $sql = mysql_query("SELECT * from v_garage WHERE approval='rejected'");
                          if (mysql_num_rows($sql) == 0) {
                        	echo "No Rejected Garages Available";
                        }
                        else
                        {
                ...
                <div style="margin-top: 20px;">
                	<p class="bs-example bs-baseline-top"> 
                            			<a href="A_V_rejected.php?g_code=<?php echo $data['g_code'];?>"> 
