...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
 ...
 <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="description" content="Neon Admin Panel" />
     ...
     <title>Garage | Pending</title> <link rel="stylesheet" href="assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css" id="style-resource-1">
...
<div class="row"> 
           <div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;"><h2>Garage Pending List</h2></div>
 ...
 <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce" style="padding: 20px;">
   			...
   			<li>
   				<a href="A_pendding.php">Pendding List</a> 
   			</li>
   			</ol><br />
                ...
                <div>
                    ...
                    <?php
                        $sql = mysql_query("SELECT * from v_garage WHERE approval='pending'");
                        if (mysql_num_rows($sql) == 0) {
                        	echo "No Pendding Request Available";
                        }
                        else
                        {
				                       ...
				                       <div class="col-xs-5" style="float: right;   "> 
						                <a href="#"> 
						             	 <img src="<?php  if($data['g_imageurl1'] == NULL) { echo "../uploads/v_profile/user.png"; }else{ echo $data['g_imageurl1'];} ?>" style='height:150px; border-radius: 5px 5px 5px 5px;  width:150px; class='img-responsive img-rounded full-width /> 
							            </a> 
							           </div>      	
