...
<div class="main-content">  
	<div class="row"> 
           <div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;"><h2>Towing Rejected List</h2></div>
...
<div class="dashboard-wrapper">
 ...
 <ol class="breadcrumb bc-3" > 	
   			...
   			<li>
   				<a href="T_rejected.php">Rejected List</a> 
   			</li>
   			</ol><br />
                ...
                <div>
                    ...
                    <?php
                        $sql = mysql_query("SELECT * from t_vender WHERE approval='rejected'");
                         if (mysql_num_rows($sql) == 0) {
                        	echo "No Rejected Towing vendor Available";
                        }
                        else
                        {
                ...
                <div style="margin-top: 20px;">
                	<p class="bs-example bs-baseline-top"> 
                            			<a href="T_V_rejected.php?t_code=<?php echo $data['t_code'];?>"> 
