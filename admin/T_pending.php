 ...
 <meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="description" content="Neon Admin Panel" />
   <meta name="author" content="Laborator.co" /> 
     ...
     <title>Tow | Pending</title> <link rel="stylesheet" href="assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css" id="style-resource-1">
...
<div class="row"> 
           <div class="col-md-6 col-sm-4 clearfix hidden-xs" style="float: left; display:inline;"><h2>Towing Pending List</h2></div>
 ...
 <div class="dashboard-wrapper">
            ...
            <ol class="breadcrumb bc-3" > 	
   			...
   			<li>
   				<a href="T_pending.php">Pending List</a> 
   			</li>
   			</ol><br />
                ...
                <div>
                    ...
                    <?php
                        $sql = mysql_query("SELECT * from t_vender WHERE approval='pending'");
                         if (mysql_num_rows($sql) == 0) {
                        	echo "No Pending Towing vendor Available";
                        }
                        else
                        {
                    ...
                    <table >
	                   <form method="POST"> 
                            <tr>
	                           <td style="padding-right: 20px;"><h4 ><b>Garage Name</b></h4><td><h4 style="padding-right: 5px;">:</h4></td></td> <td><h4><?php echo $data['t_name']; ?></h4></td>
                            </tr>
                            <tr>
                ...
                <div style="margin-top: 20px;">
                	<p class="bs-example bs-baseline-top"> 
                            			<a href="T_V_detail.php?t_code=<?php echo $data['t_code'];?>"> 
