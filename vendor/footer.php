...
<?php
        ...
        $fid = "GV";
        $qry=mysql_query("INSERT INTO `v_feedback`(femail,fmessage,fid)VALUES('$femail','$fmessage','$fid')");
       	}
          ...
          <div class="horizontal-contact-widget mt-30 pt-30 text-center">
            ...
            <div class="col-sm-12 col-sm-4 mt-sm-50">
              <div class="each-widget"> <i class="pe-7s-mail font-36 mb-10"></i>
                ...
                <p><a href="mailto:carcareservice16122@gmail.com">carcareservice16122@gmail.com</a></p>
              </div>
            </div>
          </div>
        </div>
